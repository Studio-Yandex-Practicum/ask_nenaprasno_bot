...
from bot import DAILY_CONSULTATIONS_REMINDER_JOB, DAILY_OVERDUE_CONSULTATIONS_REMINDER_JOB, init_webhook
...
async def start_bot() -> None:
    ...
    await bot_app.start()
    due_today_reminder = bot_app.job_queue.get_jobs_by_name(DAILY_CONSULTATIONS_REMINDER_JOB)[0]
    overdue_reminder = bot_app.job_queue.get_jobs_by_name(DAILY_OVERDUE_CONSULTATIONS_REMINDER_JOB)[0]
    await due_today_reminder.run(bot_app)
